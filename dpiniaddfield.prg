...
//  LOCAL cFileChk:=cId+".CHK",aFields:={},aFiles:={}
  ...
  EJECUTAR("DPAFILIASAS_CREA") // Crear tablas de aliaciones
...
//  ENDIF
  ...
  EJECUTAR("DPFILEXPCCHK") // migrado desde DPINI, 23/07/2024
...
// Tablas Innecesarias
  ...
  IF oDp:cType="SGE"
    ...
    // visualizar documentos con retenciones

    EJECUTAR("CREATERECORD","DPMENU",{"MNU_CODIGO","MNU_MODULO","MNU_HORIZO","MNU_VERTIC","MNU_ACCION"                  ,"MNU_CONDIC","MNU_TIPO","MNU_TITULO"   },;
                                     {"03T18"     ,"03"        ,"18"        ,"T"         ,[EJECUTAR("DPFACTURAV","TIK")],[]          ,1        ,[{oDp:CLITIKDESCRI}]},;
                                     NIL,.T.,"MNU_CODIGO"+GetWhere("=","03T18"))

    SQLUPDATE("DPMENU",{"MNU_CODIGO","MNU_VERTIC","MNU_HORIZO","MNU_TITULO"},;
                       {"08C74"     ,"C"         ,"74"        ,"Visualizar documentos del proveedor con retenciones"},;
                       "MNU_CODIGO"+GetWhere("=","08P04"))

    SQLUPDATE("DPMENU",{"MNU_CODIGO","MNU_VERTIC","MNU_HORIZO"},;
                       {"08O20"     ,"O"         ,"20"        },;
                       "MNU_CODIGO"+GetWhere("=","08P60"))

    SQLDELETE("DPMENU","MNU_CODIGO"+GetWhere("=","08P26"))
    SQLUPDATE("DPMENU","MNU_TITULO","Calcular Hábitat y Vivienda","MNU_CODIGO"+GetWhere("=","08P44")) 
    SQLUPDATE("DPMENU",{"MNU_TITULO","MNU_TIPO"},{"Calcular (ARI) por trabajador",0},"MNU_CODIGO"+GetWhere("=","08P45"))
    SQLUPDATE("DPMENU","MNU_TIPO",0,"MNU_CODIGO"+GetWhere("=","08P20"))
...
//? oDp:cSql	
  ...
  EJECUTAR("CREARLIBVTAMES")
    ...
    EJECUTAR("CREATERECORD","DPMENU",{"MNU_CODIGO","MNU_MODULO","MNU_HORIZO","MNU_VERTIC","MNU_ACCION"          ,"MNU_CONDIC" ,"MNU_TIPO","MNU_TITULO"   },;
                                     {"08P42"     ,"08"        ,"42"        ,"P"         ,[EJECUTAR("IVSSOTOCXP","SSO")],[.T.]        ,1       ,[Calcular Seguro Social IVSSO]},;
